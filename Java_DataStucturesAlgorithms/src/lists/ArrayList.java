...
public class ArrayList<E> implements List<E> {
  ...
  private E[] data;                        // generic array used for storage 用来存储 ArrayList 元素的数组。
  ...
  // 为什么使用 new Object[capacity] 而不是 new E[capacity]？
  // 编译过程中， 泛型类型信息会被擦除 (erased)， 替换为它们的原始类型 (raw type)， 如果没有指定上限， 原始类型通常是 Object。
  // 为了解决泛型数组创建问题， Java 采取的折中方案是：  先创建一个 Object 数组 new Object[capacity]。
