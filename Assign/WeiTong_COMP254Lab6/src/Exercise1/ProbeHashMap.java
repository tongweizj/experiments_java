...
/**
 * Concrete implementation of a hash map using linear probing for collision resolution.
 */
public class ProbeHashMap<K,V> extends AbstractHashMap<K,V> {
    private MapEntry<K,V>[] table;        // the hash table
    private MapEntry<K,V> DEFUNCT = new MapEntry<>(null, null);  // marker for defunct entries
    ...
    /**
     * Associates key k with value v in bucket with hash value h, returning old value.
     */
    @Override
